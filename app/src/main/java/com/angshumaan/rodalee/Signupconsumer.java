...
public class Signupconsumer extends AppCompatActivity {
    ...
    private String register_url = "http://192.168.43.219/database/consumer_register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signupconsumer);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(Signupconsumer.this);
